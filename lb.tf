...
# Target group is a group of targets that the load balancer will send traffic to
...
# Load Balancer Security Group (allows HTTP traffic on port 80)
...
# Listener: forwards HTTP port 80 traffic to the Target Group
